...
#> 
#> ### [LOW] base::sort
#> - File: file1b7a46f349d5.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmpgv5JBO/file1b7a46f349d5.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
#> |---|---|---|---|---|---|
#> | 1 | base::sort | LOW | file1b7a46f349d5.R:5 | locale_check | sort() output is locale-sensitive. Current locale: C.UTF-8. Results may differ on machines with different LC_COLLATE ... |
#> 
#> ## 5. Drift assessment
#> 
#> | Output | Status | Note |
...
#> reproducr: report written to '/tmp/Rtmpgv5JBO/file1b7a789887e5.md'
...
#> reproducr: report written to '/tmp/Rtmpgv5JBO/file1b7ab97dacd.html'
...
#> reproducr: badge updated in '/tmp/Rtmpgv5JBO/file1b7ae4934b.md'
