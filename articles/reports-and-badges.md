...
#> 
#> ### [LOW] base::sort
#> - File: file1c1a7a20c4d7.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpJMkabG/file1c1a7a20c4d7.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpJMkabG/file1c1a1f74aa5.md'
...
#> reproducr: report written to '/tmp/RtmpJMkabG/file1c1a1e5c9536.html'
...
#> reproducr: badge updated in '/tmp/RtmpJMkabG/file1c1a48c4a94c.md'
