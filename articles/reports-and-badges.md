...
#> 
#> ### [HIGH] stats::rnorm
#> - File: file1b546779707a.R, line 4
#> - Check: changelog
...
#> 
#> ### [LOW] base::sort
#> - File: file1b546779707a.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmpdpup80/file1b546779707a.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/Rtmpdpup80/file1b547ab804c8.md'
...
#> reproducr: report written to '/tmp/Rtmpdpup80/file1b548212549.html'
...
#> reproducr: badge updated in '/tmp/Rtmpdpup80/file1b54429e001c.md'
