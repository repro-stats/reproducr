...
#> 
#> ### [LOW] base::sort
#> - File: file1ba865e800a2.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpYMhfW5/file1ba865e800a2.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpYMhfW5/file1ba8726f85aa.md'
...
#> reproducr: report written to '/tmp/RtmpYMhfW5/file1ba837fbea98.html'
...
#> reproducr: badge updated in '/tmp/RtmpYMhfW5/file1ba870b12329.md'
