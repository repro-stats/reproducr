...
#> 
#> ### [LOW] base::sort
#> - File: file1c7823dd08dd.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpO8JHNg/file1c7823dd08dd.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpO8JHNg/file1c782d72fdfa.md'
...
#> reproducr: report written to '/tmp/RtmpO8JHNg/file1c78517d5e2d.html'
...
#> reproducr: badge updated in '/tmp/RtmpO8JHNg/file1c782508973b.md'
