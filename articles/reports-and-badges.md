...
#> 
#> ### [LOW] base::sort
#> - File: file1c305069316f.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpKXPijn/file1c305069316f.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpKXPijn/file1c3073a4bf72.md'
...
#> reproducr: report written to '/tmp/RtmpKXPijn/file1c302e34e4ae.html'
...
#> reproducr: badge updated in '/tmp/RtmpKXPijn/file1c304e59de90.md'
