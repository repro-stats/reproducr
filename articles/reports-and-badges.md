...
#> 
#> ### [LOW] base::sort
#> - File: file1c87206e0c6e.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpxipCO8/file1c87206e0c6e.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
#> |---|---|---|---|---|---|
#> | 1 | base::sort | LOW | file1c87206e0c6e.R:5 | locale_check | sort() output is locale-sensitive. Current locale: C.UTF-8. Results may differ on machines with different LC_COLLATE ... |
#> 
#> ## 5. Drift assessment
#> 
#> | Output | Status | Note |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpxipCO8/file1c871997d96a.md'
...
#> reproducr: report written to '/tmp/RtmpxipCO8/file1c872116cfdd.html'
...
#> reproducr: badge updated in '/tmp/RtmpxipCO8/file1c8751cdae21.md'
