...
#> 
#> ### [LOW] base::sort
#> - File: file1c2e3b752dbd.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmp0329CF/file1c2e3b752dbd.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/Rtmp0329CF/file1c2e4c47e13b.md'
...
#> reproducr: report written to '/tmp/Rtmp0329CF/file1c2e1763d1e6.html'
...
#> reproducr: badge updated in '/tmp/Rtmp0329CF/file1c2e55b0fad1.md'
