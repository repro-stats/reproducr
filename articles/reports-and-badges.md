...
#> 
#> ### [LOW] base::sort
#> - File: file1c3d6af66d6f.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmp77EnFF/file1c3d6af66d6f.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/Rtmp77EnFF/file1c3d290a37ca.md'
...
#> reproducr: report written to '/tmp/Rtmp77EnFF/file1c3d1d2577f4.html'
...
#> reproducr: badge updated in '/tmp/Rtmp77EnFF/file1c3d4e1e7726.md'
