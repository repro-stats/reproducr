...
#> 
#> ### [LOW] base::sort
#> - File: file1c5430f5a6fc.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpmZIBvH/file1c5430f5a6fc.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpmZIBvH/file1c543b2da002.md'
...
#> reproducr: report written to '/tmp/RtmpmZIBvH/file1c54a8222e2.html'
...
#> reproducr: badge updated in '/tmp/RtmpmZIBvH/file1c545be558a5.md'
