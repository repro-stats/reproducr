...
#> 
#> ### [LOW] base::sort
#> - File: file1c16285aafd2.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpDqlfFK/file1c16285aafd2.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpDqlfFK/file1c166c612f3.md'
...
#> reproducr: report written to '/tmp/RtmpDqlfFK/file1c16384b177a.html'
...
#> reproducr: badge updated in '/tmp/RtmpDqlfFK/file1c1666365020.md'
