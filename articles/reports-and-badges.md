...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmpjk73db/file1cac9e92337.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
#> |---|---|---|---|---|---|
#> | 1 | base::sort | LOW | file1cac9e92337.R:5 | locale_check | sort() output is locale-sensitive. Current locale: C.UTF-8. Results may differ on machines with different LC_COLLATE ... |
#> 
#> ## 5. Drift assessment
#> 
#> | Output | Status | Note |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/Rtmpjk73db/file1cac37f77770.md'
...
#> reproducr: report written to '/tmp/Rtmpjk73db/file1cac459736be.html'
...
#> reproducr: badge updated in '/tmp/Rtmpjk73db/file1cac5e0beacc.md'
