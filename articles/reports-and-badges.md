...
#> 
#> ### [HIGH] stats::rnorm
#> - File: file1b27259632dd.R, line 4
#> - Check: changelog
...
#> 
#> ### [LOW] base::sort
#> - File: file1b27259632dd.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpmSidvC/file1b27259632dd.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpmSidvC/file1b276eb137f0.md'
...
#> reproducr: report written to '/tmp/RtmpmSidvC/file1b271c8c500f.html'
...
#> reproducr: badge updated in '/tmp/RtmpmSidvC/file1b27eb21057.md'
