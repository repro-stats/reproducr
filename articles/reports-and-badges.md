...
#> 
#> ### [LOW] base::sort
#> - File: file1c35338d8006.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmpu8e1zC/file1c35338d8006.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/Rtmpu8e1zC/file1c35240c29c.md'
...
#> reproducr: report written to '/tmp/Rtmpu8e1zC/file1c3516cbb929.html'
...
#> reproducr: badge updated in '/tmp/Rtmpu8e1zC/file1c357a9f7e8d.md'
