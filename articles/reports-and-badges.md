...
#> 
#> ### [LOW] base::sort
#> - File: file1b4174094868.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpU0L5Dh/file1b4174094868.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpU0L5Dh/file1b416dc50b03.md'
...
#> reproducr: report written to '/tmp/RtmpU0L5Dh/file1b4123ce5832.html'
...
#> reproducr: badge updated in '/tmp/RtmpU0L5Dh/file1b41703db7ba.md'
