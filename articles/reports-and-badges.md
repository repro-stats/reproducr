...
#> 
#> ### [HIGH] stats::rnorm
#> - File: file1b9034d77d94.R, line 4
#> - Check: changelog
...
#> 
#> ### [LOW] base::sort
#> - File: file1b9034d77d94.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpSJNTrH/file1b9034d77d94.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpSJNTrH/file1b9040b5accc.md'
...
#> reproducr: report written to '/tmp/RtmpSJNTrH/file1b901c88598f.html'
...
#> reproducr: badge updated in '/tmp/RtmpSJNTrH/file1b901daa62d4.md'
