...
#> 
#> ### [LOW] base::sort
#> - File: file1c895191b890.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmp5Hoa0J/file1c895191b890.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
#> |---|---|---|---|---|---|
#> | 1 | base::sort | LOW | file1c895191b890.R:5 | locale_check | sort() output is locale-sensitive. Current locale: C.UTF-8. Results may differ on machines with different LC_COLLATE ... |
#> 
#> ## 5. Drift assessment
#> 
#> | Output | Status | Note |
...
#> reproducr: report written to '/tmp/Rtmp5Hoa0J/file1c893de6b626.md'
...
#> reproducr: report written to '/tmp/Rtmp5Hoa0J/file1c89b350279.html'
...
#> reproducr: badge updated in '/tmp/Rtmp5Hoa0J/file1c8917973dba.md'
