...
print(report)
#> 
#> -- reproducr audit report [2026-05-31 13:05] --
#> 
#>   Files scanned:     1
#>   Packages found:    3
#>   Calls detected:    5
...
#> 1 /tmp/Rtmpfz4sNB/file1b582f69b84f.R    3 dplyr    filter        <NA>
#> 2 /tmp/Rtmpfz4sNB/file1b582f69b84f.R    4 dplyr summarise        <NA>
#> 3 /tmp/Rtmpfz4sNB/file1b582f69b84f.R    4 dplyr         n        <NA>
#> 4 /tmp/Rtmpfz4sNB/file1b582f69b84f.R    6 stats     rnorm       4.6.0
#> 5 /tmp/Rtmpfz4sNB/file1b582f69b84f.R    7  base      sort       4.6.0
```
...
#>   LOW:       1
#> 
#> [HIGH]    stats::rnorm  (line 6 in file1b582f69b84f.R)
#>          Check    : changelog
...
#> 
#> [LOW]     base::sort  (line 7 in file1b582f69b84f.R)
#>          Check    : locale_check
...
#> 1 /tmp/Rtmpfz4sNB/file1b582f69b84f.R    6 stats::rnorm       4.6.0 high
#> 2 /tmp/Rtmpfz4sNB/file1b582f69b84f.R    7   base::sort       4.6.0  low
#>          check
#> 1    changelog
#> 2 locale_check
#>                                                                                                                                 description
...
#> 1 baseline-v1 2026-05-31T13:05:09+0000     4.6.0 Linux 6.17.0-1015-azure
#>   n_outputs                             script
#> 1         3 /tmp/Rtmpfz4sNB/file1b582f69b84f.R
```
