...
print(report)
#> 
#> -- reproducr audit report [2026-06-20 19:29] --
#> 
#>   Files scanned:     1
#>   Packages found:    3
#>   Calls detected:    5
...
#> 1 /tmp/RtmpWOWb5W/file1b69783c9bd1.R    3 dplyr    filter        <NA>
#> 2 /tmp/RtmpWOWb5W/file1b69783c9bd1.R    4 dplyr summarise        <NA>
#> 3 /tmp/RtmpWOWb5W/file1b69783c9bd1.R    4 dplyr         n        <NA>
#> 4 /tmp/RtmpWOWb5W/file1b69783c9bd1.R    6 stats     rnorm       4.6.0
#> 5 /tmp/RtmpWOWb5W/file1b69783c9bd1.R    7  base      sort       4.6.0
```
...
#>   LOW:       1
#> 
#> [LOW]     base::sort  (line 7 in file1b69783c9bd1.R)
#>          Check    : locale_check
...
#> 1 /tmp/RtmpWOWb5W/file1b69783c9bd1.R    7 base::sort       4.6.0  low
#>          check
#> 1 locale_check
#>                                                                                                                                 description
...
#> 1 baseline-v1 2026-06-20T19:29:18+0000     4.6.0 Linux 6.17.0-1018-azure
#>   n_outputs                             script
#> 1         3 /tmp/RtmpWOWb5W/file1b69783c9bd1.R
```
