...
#> 1 /tmp/RtmpBLu63s/file1b0b24cabdbe.R    3 dplyr    filter        <NA>
#> 2 /tmp/RtmpBLu63s/file1b0b24cabdbe.R    4 dplyr summarise        <NA>
#> 3 /tmp/RtmpBLu63s/file1b0b24cabdbe.R    4 dplyr         n        <NA>
#> 4 /tmp/RtmpBLu63s/file1b0b24cabdbe.R    6 stats     rnorm       4.6.0
#> 5 /tmp/RtmpBLu63s/file1b0b24cabdbe.R    7  base      sort       4.6.0
```
...
#>   LOW:       1
#> 
#> [HIGH]    stats::rnorm  (line 6 in file1b0b24cabdbe.R)
#>          Check    : changelog
...
#> 
#> [LOW]     base::sort  (line 7 in file1b0b24cabdbe.R)
#>          Check    : locale_check
...
#> 1 /tmp/RtmpBLu63s/file1b0b24cabdbe.R    6 stats::rnorm       4.6.0 high
#> 2 /tmp/RtmpBLu63s/file1b0b24cabdbe.R    7   base::sort       4.6.0  low
#>          check
#> 1    changelog
#> 2 locale_check
#>                                                                                                                                 description
...
#> 1 baseline-v1 2026-05-31T12:42:33+0000     4.6.0 Linux 6.17.0-1015-azure
#>   n_outputs                             script
#> 1         3 /tmp/RtmpBLu63s/file1b0b24cabdbe.R
```
