...
print(report)
#> 
#> -- reproducr audit report [2026-06-08 18:49] --
#> 
#>   Files scanned:     1
#>   Packages found:    3
#>   Calls detected:    5
...
#> 1 /tmp/RtmpyfH2PV/file1c4e76ad79f3.R    3 dplyr    filter        <NA>
#> 2 /tmp/RtmpyfH2PV/file1c4e76ad79f3.R    4 dplyr summarise        <NA>
#> 3 /tmp/RtmpyfH2PV/file1c4e76ad79f3.R    4 dplyr         n        <NA>
#> 4 /tmp/RtmpyfH2PV/file1c4e76ad79f3.R    6 stats     rnorm       4.6.0
#> 5 /tmp/RtmpyfH2PV/file1c4e76ad79f3.R    7  base      sort       4.6.0
```
...
#>   LOW:       1
#> 
#> [LOW]     base::sort  (line 7 in file1c4e76ad79f3.R)
#>          Check    : locale_check
...
#> 1 /tmp/RtmpyfH2PV/file1c4e76ad79f3.R    7 base::sort       4.6.0  low
#>          check
#> 1 locale_check
#>                                                                                                                                 description
...
#> 1 baseline-v1 2026-06-08T18:49:05+0000     4.6.0 Linux 6.17.0-1015-azure
#>   n_outputs                             script
#> 1         3 /tmp/RtmpyfH2PV/file1c4e76ad79f3.R
```
