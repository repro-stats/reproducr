...
#> reproducr: certified 6 output(s) [2026-06-16] under tag 'baseline-v1'
```
...
#> reproducr: certified 1 output(s) [2026-06-16] under tag 'pre-peer-review'
...
#> reproducr: certified 1 output(s) [2026-06-16] under tag 'post-revision'
```
...
#> reproducr: certified 3 output(s) [2026-06-16] under tag 'four-statuses'
...
#> reproducr: certified 1 output(s) [2026-06-16] under tag 'run-1'
certify(outputs = list(x = 1L), tag = "run-2", file = cert_file)
#> reproducr: certified 1 output(s) [2026-06-16] under tag 'run-2'
certify(outputs = list(x = 1L), tag = "run-3", file = cert_file)
#> reproducr: certified 1 output(s) [2026-06-16] under tag 'run-3'
