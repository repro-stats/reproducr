...
> readr (v2.1.5). Package environments were managed using renv
> (Ushey & Wickham, 2023). Reproducibility auditing (reproducr) identified
> no risks. The full audit report and certification records are available in
