...
print(report)
#> 
#> -- reproducr audit report [2026-06-02 13:33] --
#> 
#>   Files scanned:     1
#>   Packages found:    2
#>   Calls detected:    3
...
report$calls
#>                                 file line   pkg        fn pkg_version
#> 1 /tmp/RtmpdUnipC/file1a37524c55e2.R    2 dplyr    filter        <NA>
#> 2 /tmp/RtmpdUnipC/file1a37524c55e2.R    3 dplyr summarise        <NA>
#> 3 /tmp/RtmpdUnipC/file1a37524c55e2.R    4 stats     rnorm       4.6.0
```
